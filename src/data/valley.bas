...
2209 REM ** NOTHING, MONSTER OF FIND PERHAPS
2210 RF=RND(TI)
...
2400 RETURN
2410 PRINT D$;"YOU FELL THE AURA OF THE DEPP MAGIC..."
...
3830 DF=110:GOSUB 360000:REM ** DELAY + UPDATE
...
4160 G=INT((((MS*75*RND(TI))-(10*CS)-E_/100)*Z)
...
45010 RT=INT(0.067*(EX+TS/3)^0.5+LOG(EX/((TN+1)^1.5))):IF RT>28 THE RT=28
