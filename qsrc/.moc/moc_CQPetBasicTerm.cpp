/****************************************************************************
** Meta object code from reading C++ file 'CQPetBasicTerm.h'
**
...
#error "The header file 'CQPetBasicTerm.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(3, 30, 13), // "updateTimeout"
QT_MOC_LITERAL(4, 44, 11) // "loopTimeout"

    },
    "CQPetBasicTerm\0cursorTimeout\0\0"
    "updateTimeout\0loopTimeout"
};
...
void *CQPetBasicTerm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "CPetBasicTerm"))
        return static_cast< CPetBasicTerm*>(this);
